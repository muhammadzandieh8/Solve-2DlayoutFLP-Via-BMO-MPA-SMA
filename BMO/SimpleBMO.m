function temp = SimpleBMO(algorithmName,Max_iteration,chromosomes,PopSize, MachineNumber,LengthWorkshop,WidthWorkshop,ub,M,L,W,Xio,Yio,Xoo,Yoo,Lo,Wo,Xo,Yo,ylower,yupper,xlower,xupper,f,C,ShowBestAnswer,LoC,WoC,XoC,YoC,optimizedPL)
tic
disp('Simple BMO is now tackling your problem')
dimension = 3;
dim=dimension;
pl=optimizedPL;
addpath(genpath('..'))
